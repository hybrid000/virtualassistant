...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("Paradox 2.0")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("Paradox/utils/images/live_wallpaper.gif"))
...
"font: 75 18pt \"MS Shell Dlg 2\";")
        ...
        self.label_2.setPixmap(QtGui.QPixmap("Paradox/utils/images/initiating.gif"))
